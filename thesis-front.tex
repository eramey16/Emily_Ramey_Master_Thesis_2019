...
I would like to thank my advisors, Dr. Jeremy Buhler, Dr. James Buckley, and Dr. Roger Chamberlain, for their support of my research. This material is based upon work supported by the National Science Foundation Graduate Research Fellowship under Grant No. 2018268910 *(I have to ask my CO if this number is correct).
...
The Advanced Particle-Astrophysics Telescope (APT) is a concept for a gamma-ray space telescope that would operate in the keV to MeV energy range. Due to the nature of the telescope and the physics involved in detection, reconstructing initial photon trajectories through software can be very computationally complex, which is an obstacle to the real-time detection of transient phenomena such as Gamma Ray Bursts (GRBs). In this paper, we discuss several changes made to the basic reconstruction algorithm discussed in Boggs \& Jean (2000) in order to achieve greater reconstruction speeds, as well as the effects of certain algorithmic parameters on overall performance. We test our algorithm on data from a simple toy model of Compton scattering, which allows for easier development and debugging, as well as on data from CERN’s Geant 4 simulator, which provides a much greater physical and probabilistic accuracy.
